            ...
            <div class="p-4 sm:p-6 bg-white">
                <div class="">
                    ...
                    <div class="grid grid-cols-1 gap-8 sm:gap-6 sm:grid-cols-3">
                        ...
                        <div>
                            <h2 class="mb-6 text-sm font-semibold text-gray-900 uppercase">Note
                            </h2>
                            <ul class="text-gray-600">
                                <li class="mb-4">
                ...
                <div class="mt-8 sm:flex sm:items-center sm:justify-between pb-10 sm:pb-0">
                    <span class="text-sm text-gray-500 sm:text-center ">© 2022 <a href="https://flowbite.com/"
                            class="hover:underline">ArifCode</a>. All Rights Reserved.
                    </span>
                    <div class="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
                        ...
                        <a href="https://www.instagram.com/arifbudimanarrosyid/" class="text-gray-500 hover:text-gray-900 ">
                            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                                <path fill-rule="evenodd"
                        ...
                        <a href="https://github.com/arifbudimanarrosyid" class="text-gray-500 hover:text-gray-900 ">
                            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                                <path fill-rule="evenodd"
