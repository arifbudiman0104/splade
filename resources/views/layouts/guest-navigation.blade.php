            ...
            <div class="flex justify-between h-16">
                ...
                <div class="hidden sm:flex sm:items-center sm:ml-6 gap-x-4">
                    ...
                    <Link href="{{ route('login') }}"
                        class="inline-flex items-center px-3 py-2 text-sm font-medium leading-4 text-gray-400 transition duration-150 ease-in-out bg-gray-100 border border-transparent rounded-md  hover:text-gray-700  focus:outline-none">
                    Login
                    </Link>
                    @endif
